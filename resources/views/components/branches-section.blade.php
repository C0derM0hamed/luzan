<section id="branches" class="py-20 bg-white border-t border-slate-100 overflow-hidden">
    <div class="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div class="text-right space-y-2.5 mb-12 pb-6 border-b border-slate-100">
            <span class="text-[10px] font-black text-primary tracking-widest uppercase bg-primary/10 px-3.5 py-1.5 rounded-full inline-block">فروعنا الجغرافية</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
            @foreach($branches as $branch)
                <div class="group relative overflow-hidden rounded-[28px] border border-slate-200/60 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5 flex flex-col justify-between">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-3.5">
                            <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-primary/10 text-primary border border-primary/10">
                        ...
                        <div class="mt-8 space-y-4 text-sm text-slate-600">
                            <div class="flex items-start gap-3.5">
                                <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-slate-50 text-slate-400 border border-slate-100">
                                ...
                                <span class="leading-relaxed font-semibold pt-1 text-slate-700 text-xs">{{ $branch->address }}</span>
                            </div>
                            <div class="flex items-center gap-3.5">
                                <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-slate-50 text-slate-400 border border-slate-100">
