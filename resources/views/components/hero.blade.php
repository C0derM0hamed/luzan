            ...
            <div class="w-full lg:w-[55%] text-right">
                ...
                <div class="mt-8 flex flex-wrap gap-4">
                    ...
                    <a href="{{ route('contact') }}"
                        class="inline-flex h-12 items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/10 px-8 text-sm font-bold text-white backdrop-blur-md transition-all hover:bg-white/20 hover:border-white/40 hover:-translate-y-0.5 active:translate-y-0">
