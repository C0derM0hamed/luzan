...
class DoctorController extends Controller
{
    ...
    {
        $doctors = Doctor::query()->orderBy('sort_order')->orderBy('name')->paginate(15);

        return view('admin.doctors.index', [
            'pageTitle' => 'إدارة الأطباء',
            'doctors' => $doctors,
            'tableHeaders' => ['الصورة', 'الاسم', 'التخصص', 'الترتيب', 'الحالة', 'إجراءات'],
        ]);
    }

    public function create()
    {
        return view('admin.doctors.create', ['pageTitle' => 'إضافة طبيب']);
    }
    ...
    {
        return view('admin.doctors.edit', ['pageTitle' => 'تعديل طبيب', 'doctor' => $doctor]);
    }
